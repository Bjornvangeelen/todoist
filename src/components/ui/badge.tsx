  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        priority1: "border-transparent bg-red-100 text-red-700",
        priority2: "border-transparent bg-orange-100 text-orange-700",
        priority3: "border-transparent bg-blue-100 text-blue-700",
        priority4: "border-transparent bg-gray-100 text-gray-600",
      },
    },
    defaultVariants: {
      variant: "default",
